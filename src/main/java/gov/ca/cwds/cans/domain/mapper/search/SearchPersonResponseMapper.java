...
/**
 * The mapper is written without using mapstruct to @Inject {@link PersonShortMapper}
 * which lifecycle should be managed by IoC container to support authorization.
 * The current mapstruct version does not support injection of Guice components.
 *
...
public class SearchPersonResponseMapper
  ...
  @Inject
  public SearchPersonResponseMapper(
      PersonShortMapper personShortMapper) {
